...
<head>
    <title>Senjata Tradisional</title>
    <meta charset="utf-8" />
    ...
    <div id="page-wrapper">
        ...
        <header id="header">
            <div class="logo container">
                <div>
                    <h1>
                        <a href="index.php" id="logo">Senjata Tradisional</a>
                    </h1>
                </div>
            </div>
        </header>
    ...
    <script>
        ...
        prevButton.addEventListener("click", () => {
            if (currentIndex != 0) {
                ...
                fetchItem(provinceList[currentIndex].province_id, 6);
            }
        });
